...
`dynamic_*` variants have unresolved batch/spatial axes. `dynamic_multi.mnn`
contains two independent named inputs/outputs with ReLU, so tests can vary both
shapes independently and verify all inputs are resized before any copy.
